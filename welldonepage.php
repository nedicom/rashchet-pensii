...
echo '
	<div class="text-center text-xxl-start">
                                <div class="fs-3 fw-light text-muted mt-5"><img src="img/favicon.svg" width="54px"></div>
                                <div class="fs-3 fw-light text-muted">юрист свяжется с Вами в течение 1 - 2 дней.</div> 
                                <h1 class="display-3 fw-bolder"><span class="text-gradient d-inline">Заявка успешно отправлена!</span></h1>
								<div class="fs-3 fw-light text-muted">а пока посмотрите наш  youtube канал.</div> 
                                <div class="mx-5 d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xxl-start mb-3">
                                    <a class="btn btn-lg px-5 py-3 me-sm-3 fs-6 fw-bolder" href="https://www.youtube.com/channel/UCgX-GlsXp3Ex77pnioKZTJg"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
