...
echo '
		<div class="text-center mb-3">
			<a href="\" class="d-inline-flex m-1 btn btn-primary btn-lg  d-flex disabled" aria-disabled="true">простой режим</a>
			<a href="prostoy-raschet.php" class="d-inline-flex m-1 btn btn-primary btn-lg d-flex" role="button" >экспертный режим</a>
		</div>
		
	<div class="container mt-5 col-10 c0l-md-12">
		<div class="row">
			<form class="row g-3 needs-validation" action="/rasschet.php" method="post">	
				...
				<div class="row my-3">					
					...
					<div class="col-sm-4">
						...
						<a href="https://www.gosuslugi.ru/10042/1/info" target="_blank">Заказать справку
				...
				<div class="row my-3">					
					...
					<div class="col-sm-4">
						<select class="form-select" name = "spk">
							  <option value="118.1" selected>С 01.08.2022</option>
