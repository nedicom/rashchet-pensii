...
<p>Политики <strong>предназначена</strong> для доведения до субъектов персональных данных сведений о&nbsp;порядке обработки персональных данных и мерах по обеспечению безопасности персональных данных, адвокатом Мина Марком Анатольевичем (далее &ndash; Оператор).</p>
